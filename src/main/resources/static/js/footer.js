...
document.writeln("				<span>Email：740061271@qq.com</span>");
document.writeln("				<span>Github：https://github.com/caohongye</span>");
document.writeln("				<span>微信号：caohongye19980622</span>");
document.writeln("			</div>");
document.writeln("			<div id=\'rightContent\'>");
document.writeln("				<div id=\'footIcon\'>");
document.writeln("					<img id=\'logo\' src='/img/kobe/num.jpg' />");
document.writeln("				</div>");
document.writeln("");
document.writeln("				<div id=\'copyright\'>");
document.writeln("					CopyRight@chy,DesignBy@_Mike,2020");
document.writeln("				</div>");
document.writeln("			</div>");
