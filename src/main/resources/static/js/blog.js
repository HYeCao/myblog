    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            $.each(json, function (i, item) {
                ...
                categoryInfo.content.querySelector("a").href = "?categoryId=" + item.categoryId;
    ...
    $.ajax({
        ...
        success: function (json) {
            $.each(json, function (i, item) {
                ...
                articleInfo.content.querySelector("img").src = "/img/kobe/"+item.pictureUrl+".jpg";
                if (item.top == true) {
...
function showArticle(_this) {
    ...
    var url = "/article?articleId=" + articleId;
